...
from openpilot.starpilot.tinygrad_modeld.parse_model_outputs import Parser
from openpilot.starpilot.tinygrad_modeld.fill_model_msg import fill_model_msg, fill_pose_msg, PublishState, get_curvature_from_output
from openpilot.starpilot.tinygrad_modeld.constants import ModelConstants, Plan
try:
  from openpilot.selfdrive.modeld.models.commonmodel_pyx import DrivingModelFrame, CLContext
except ImportError:
  from openpilot.starpilot.tinygrad_modeld.models.commonmodel_pyx import DrivingModelFrame, CLContext
from openpilot.starpilot.tinygrad_modeld.runners.tinygrad_helpers import qcom_tensor_from_opencl_address
from openpilot.starpilot.common.starpilot_variables import get_starpilot_toggles, MODELS_PATH, params_memory


PROCESS_NAME = "starpilot.tinygrad_modeld.tinygrad_modeld"
...
def main(demo=False):
  ...
  while True:
    ...
    if model_output is not None:
      ...
      action = get_action_from_model(model_output, prev_action, lat_delay + DT_MDL, long_delay + DT_MDL, v_ego, model.mlsim, model.is_v9, starpilot_toggles)
      prev_action = action
