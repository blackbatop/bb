...
def get_action_from_model(model_output: dict[str, np.ndarray], prev_action: log.ModelDataV2.Action,
    ...
    # Use model-provided curvature when present; otherwise derive from the MPC plan.
    ...
    # Apply light smoothing only; downstream controllers handle additional filtering.
